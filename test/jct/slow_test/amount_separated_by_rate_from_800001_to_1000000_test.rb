...
class JctTest < Minitest::Test
  def test_amount_separated_by_rateに該当する消費税が1つとなる期間と、80万1から100万までのamountを入れた際に分割された結果の合計がamountと等しいこと
    800_001.upto(1_000_000).each do |amount|
  ...
  def test_amount_separated_by_rateに該当する消費税が2つとなる期間と、80万1から100万までのamountを入れた際に分割された結果の合計がamountと等しいこと
    800_001.upto(1_000_000).each do |amount|
  ...
  def test_amount_separated_by_rateに該当する消費税が3つとなる期間と、80万1から100万までのamountを入れた際に分割された結果の合計がamountと等しいこと
    800_001.upto(1_000_000).each do |amount|
  ...
  def test_amount_separated_by_rateに該当する消費税が4つとなる期間と、80万1から100万までのamountを入れた際に分割された結果の合計がamountと等しいこと
    800_001.upto(1_000_000).each do |amount|
  ...
  def test_amount_separated_by_rateに該当する消費税が5つとなる期間と、80万1から100万までのamountを入れた際に分割された結果の合計がamountと等しいこと
    800_001.upto(1_000_000).each do |amount|
